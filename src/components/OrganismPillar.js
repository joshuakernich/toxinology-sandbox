    ...
    return <Collapsible header="Description">
      ...
      { currentDetails.master.orgclass == 'SN'?
        ...
        <Columns>
          ...
          {makePill('Subcaudal Scales',currentDetails.taxonomy.min_subcaudals+' to '+currentDetails.taxonomy.max_subcaudals, currentDetails.taxonomy.single_divided_mixed, currentDetails.taxonomy.anals_detail)}
